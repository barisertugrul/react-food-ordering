...
const Reservations = () => {
    ...
    const statusList = ["Waiting for Approval", "Approved", "Rejected"]
    ...
    const handleStatus = async (id, action) => {
        ...
        const newStatus = action === true ? 1 : 2

        if(newStatus === 1 && (item.tableNo === "" || item.tableNo === null)){
                                ...
                                <tr key={reservation?._id} className='border-b bg-secondary border-gray-700 hover:bg-primary hover:border-white transition-all cursor-pointer'>
                                    ...
                                    <td className='py-4 px-6 font-medium whitespace-nowrap hover:text-white'>
                                        <button
                                            ...
                                            onClick={() => handleStatus(reservation?._id, true)}
                                            title='Approve'
                                        ...
                                        <button
                                            ...
                                            onClick={() => handleStatus(reservation?._id, false)}
                                            title='Reject'
                                        >
